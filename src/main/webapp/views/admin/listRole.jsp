...
<body>
					...
					<div class="col-lg-12 mt-5">
						<div class="card-body">
							<div class="card-title">
								<h4 class="header-title">Danh sách quyền</h4>
								<a class="btn btn-primary "
									href="/WebCoffee/views/admin/addRole.jsp">Thêm mới</a>
									...
									<tbody>
										<c:forEach items="${requestScope.roles }" var="role">
											<tr>
												...
												<td>${role.name }</td>
												<td>
													<a href="update-role?id=${role.id }">Sửa</a> | 
													<a href="#" onclick="deleteRole('${role.id}')">Xóa</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
	...
	<script>
		function deleteRole(id) {
			...
			if (answer) {
				window.location = "delete-role?id=" + id;
			}
		}
	</script>
</body>
